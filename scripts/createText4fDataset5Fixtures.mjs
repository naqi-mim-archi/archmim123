...
if (!sourceFolder || !existsSync(sourceFolder)) {
  throw new Error('Usage: node scripts/createText4fDataset5Fixtures.mjs <dataset-folder>');
}
...
const outputPath = path.resolve('scripts/fixtures/text4f/dataset5RasterFixtures.mjs');
