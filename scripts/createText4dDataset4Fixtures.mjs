...
if (!sourceFolder || !existsSync(sourceFolder)) {
  throw new Error('Usage: node scripts/createText4dDataset4Fixtures.mjs <dataset-folder>');
}
...
const outputPath = path.resolve('scripts/fixtures/text4d/dataset4RasterFixtures.mjs');
