...
if (!sourceFolder || !existsSync(sourceFolder)) {
  throw new Error('Usage: node scripts/createText4jDataset5Fixtures.mjs <dataset-folder>');
}
...
const outputPath = path.resolve('scripts/fixtures/text4j/dataset5RasterFixtures.mjs');
