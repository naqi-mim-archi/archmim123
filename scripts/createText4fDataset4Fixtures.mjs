...
if (!sourceFolder || !existsSync(sourceFolder)) {
  throw new Error('Usage: node scripts/createText4fDataset4Fixtures.mjs <dataset-folder>');
}
...
const outputPath = path.resolve('scripts/fixtures/text4f/dataset4RasterFixtures.mjs');
