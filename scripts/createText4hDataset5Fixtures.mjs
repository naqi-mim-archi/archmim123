...
if (!sourceFolder || !existsSync(sourceFolder)) {
  throw new Error('Usage: node scripts/createText4hDataset5Fixtures.mjs <dataset-folder>');
}
...
const outputPath = path.resolve('scripts/fixtures/text4h/dataset5RasterFixtures.mjs');
