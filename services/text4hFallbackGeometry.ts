...
const boundaryBox = (brief: ConfirmedText4hBrief, requestedBoundary?: Point[]): Box => {
...
const expandedRoomLabels = (brief: ConfirmedText4hBrief): string[] => brief.rooms.flatMap(room =>
 ...
 */
export const buildText4hFallbackGeometry = (
