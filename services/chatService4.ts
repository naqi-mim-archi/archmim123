...
export const refineDesignRequirements4 = async (
...
Total Area: <...> (Provide BOTH the total area and the dimensions. e.g. "1000 sq ft (25' x 40')" or "93 sqm (10m x 9.3m)". If the user only provides area, infer sensible dimensions. If the user provides dimensions, calculate the area)

Rooms Included:
<bullet list of rooms with counts and notable attached baths/features>

Room Adjacency:
<bullet list of adjacency rules or zoning notes>
...
If any values are inferred, keep the output confident and clean (do not mention "inferred" explicitly).`;
