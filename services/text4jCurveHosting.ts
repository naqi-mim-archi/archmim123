...
/**
 * Text 4.0 J-only hosted-insert geometry for native arcs and ellipses.
 ...
 */
export const text4jCurveHostedPose = (wall: ArchElement, hostT: number, width: number) => {
...
export const projectText4jPointToCurve = (wall: ArchElement, point: Point) => {
  let bestT = 0;
  ...
  const pose = text4jCurveHostedPose(wall, bestT, 0.01);
