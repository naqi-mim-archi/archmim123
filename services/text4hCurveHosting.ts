...
/**
 * Text 4.0 H-only hosted-insert geometry for native arcs and ellipses.
 ...
 */
export const text4hCurveHostedPose = (wall: ArchElement, hostT: number, width: number) => {
...
export const projectText4hPointToCurve = (wall: ArchElement, point: Point) => {
  let bestT = 0;
  ...
  const pose = text4hCurveHostedPose(wall, bestT, 0.01);
