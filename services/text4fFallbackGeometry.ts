...
const boundaryBox = (brief: ConfirmedText4fBrief, requestedBoundary?: Point[]): Box => {
...
const expandedRoomLabels = (brief: ConfirmedText4fBrief): string[] => brief.rooms.flatMap(room =>
 ...
 */
export const buildText4fFallbackGeometry = (
