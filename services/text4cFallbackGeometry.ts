...
const boundaryBox = (brief: ConfirmedText4cBrief, requestedBoundary?: Point[]): Box => {
...
const expandedRoomLabels = (brief: ConfirmedText4cBrief): string[] => brief.rooms.flatMap(room =>
 ...
 */
export const buildText4cFallbackGeometry = (
  brief: ConfirmedText4cBrief,
