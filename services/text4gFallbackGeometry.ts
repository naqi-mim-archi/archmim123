...
const boundaryBox = (brief: ConfirmedText4gBrief, requestedBoundary?: Point[]): Box => {
...
const expandedRoomLabels = (brief: ConfirmedText4gBrief): string[] => brief.rooms.flatMap(room =>
 ...
 */
export const buildText4gFallbackGeometry = (
