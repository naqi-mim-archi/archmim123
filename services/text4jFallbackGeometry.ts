...
const boundaryBox = (brief: ConfirmedText4jBrief, requestedBoundary?: Point[]): Box => {
...
const expandedRoomLabels = (brief: ConfirmedText4jBrief): string[] => brief.rooms.flatMap(room =>
 ...
 */
export const buildText4jFallbackGeometry = (
