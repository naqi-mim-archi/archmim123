...
const boundaryBox = (brief: ConfirmedText4dBrief, requestedBoundary?: Point[]): Box => {
...
const expandedRoomLabels = (brief: ConfirmedText4dBrief): string[] => brief.rooms.flatMap(room =>
 ...
 */
export const buildText4dFallbackGeometry = (
