...
/**
 * Text 4.0 F-only hosted-insert geometry for native arcs and ellipses.
 ...
 */
export const text4fCurveHostedPose = (wall: ArchElement, hostT: number, width: number) => {
...
export const projectText4fPointToCurve = (wall: ArchElement, point: Point) => {
  let bestT = 0;
  ...
  const pose = text4fCurveHostedPose(wall, bestT, 0.01);
