const TEXT4E_VARIATION_PROFILES = [
...
export const getText4eConversationProfile = (variationIndex = 0) =>
  TEXT4E_VARIATION_PROFILES[Math.abs(Math.trunc(variationIndex)) % TEXT4E_VARIATION_PROFILES.length];
