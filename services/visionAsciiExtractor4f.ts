...
export async function extractZoningFromImage4f(base64Image: string): Promise<ExtractedZoningData> {
  const base64Eata = base64Image.replace(/^data:image\/(png|jpeg);base64,/, "");
